...
class DataManagerTests(unittest.TestCase):
    ...
    def test_no_filters(self):
        data = self.manager.request('no_filters', {'data': 1234})
    ...
    def test_one_filter(self):
        ...
        data = self.manager.request('one_filter', {'dummy': 4444})
    ...
    def test_multiple_filters(self):
        ...
        data = self.manager.request('multiple_filters', {'dummy': 0})
    ...
    def test_priorities(self):
        ...
        data = self.manager.request('priorities', {'list': []})
